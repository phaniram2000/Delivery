...
//     //
//     //
//     public SerializedProperty joystick;
...
//         joystick = SO.FindProperty("DynamicJoystick");
//     }
//
...
//         accelerationMultiplier.intValue =
//             EditorGUILayout.IntSlider("Acceleration Multiplier:", accelerationMultiplier.intValue, 1, 10);
...
//         decelerationMultiplier.intValue =
//             EditorGUILayout.IntSlider("Deceleration Multiplier:", decelerationMultiplier.intValue, 1, 10);
//         handbrakeDriftMultiplier.intValue =
//             EditorGUILayout.IntSlider("Drift Multiplier:", handbrakeDriftMultiplier.intValue, 1, 10);
...
//         GUILayout.Space(10);
//
//         useEffects.boolValue =
//             EditorGUILayout.BeginToggleGroup("Use effects (particle systems)?", useEffects.boolValue);
//         GUILayout.Space(10);
//
...
//         GUILayout.Space(10);
//
//         useTouchControls.boolValue =
//             EditorGUILayout.BeginToggleGroup("Use touch controls (mobile devices)?", useTouchControls.boolValue);
//         GUILayout.Space(10);
//
...
//         EditorGUILayout.PropertyField(joystick, new GUIContent("Dynamic Joystick: "));
//
//         EditorGUILayout.EndToggleGroup();
//
//         //END
