...
namespace Gadd420
{
    public class Input_Manager : MonoBehaviour
    {
        ...
        protected virtual void VerticalInput()
        {
            ...
            if (Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.S) || dynamicJoystick.Vertical < 0 ||
                dynamicJoystick.Vertical > 0.01f)
            {
                if (Input.GetKey(KeyCode.W) || dynamicJoystick.Vertical > 0.01f)
                {
                    if (vInput < 0)
                    {
                ...
                if (Input.GetKey(KeyCode.S) || dynamicJoystick.Vertical < 0)
                {
                    if (vInput > 0.01f)
                    {
                        vInputTime -= 2 * Time.deltaTime;
        ...
        protected virtual void HZInput()
        {
            ...
            if (Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.A) || dynamicJoystick.Horizontal < 0 ||
                dynamicJoystick.Horizontal > 0.01f)
            {
                ...
                if (Input.GetKey(KeyCode.A) || dynamicJoystick.Horizontal < 0)
                {
                    if (hzInput > 0.01f)
                    {
                        hzInputTime -= 2 * Time.deltaTime;
